...
import {
  buildRoutes as buildEvents,
  buildPublicRoutes as buildEventsPublic,
} from '@junius/plugin-events';
...
export const routeTree = rootRoute.addChildren([
  authedLayoutRoute.addChildren([indexRoute, eventsParent]),
  eventsPublicParent,
]);

export const PUBLIC_ROUTE_PREFIXES: string[] = ['/i/events'];
