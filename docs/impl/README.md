...
| # | Milestone | What lands | Verify by |
|---|---|---|---|
...
| **M11** | [Deployment workflow](12-M11-deployment-workflow.md) | `[source]` resolution, `platform.lock`, example deployment dir | Build a binary from outside the source repo |
